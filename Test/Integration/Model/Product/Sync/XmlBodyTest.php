...
class XmlBodyTest extends TestCase
{
     ...
     * @magentoConfigFixture klevu_test_store_1_store klevu_search/attributes/other
     *     klevu_boolean_attribute,meta_keyword,meta_title
    ...
    public function testConfigurableProduct(): void
    {
        ...
        $parentProduct = $this->productRepository->get('klevu_config_synctest_xmlbody_instock_childinstock');
        $childProduct = $this->productRepository->get('klevu_configchild_synctest_xmlbody_instock');
        $store = $this->storeManager->getStore('klevu_test_store_1');
    ...
    protected function setUp(): void
    {
        ...
        $this->baseUrl = $scopeConfig->getValue('web/unsecure/base_url');
        $useRewrites = $scopeConfig->isSetFlag('web/seo/use_rewrites');
        if (!$useRewrites) {
     ...
     * @return void
     */
    private function assertStringContainsStringBackCompat($needle, $haystack, $message = ''): void
    {
